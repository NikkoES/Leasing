package com.luckynineapps.indoleasing.views;
/* 
...
public class TemplateView extends FrameLayout {
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.view_medium_native_ads) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.view_native_ads) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.view_medium_native_ads);
        } finally {
            attributes.recycle();
        }
