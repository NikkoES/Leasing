...
public class ColumnHeaderViewHolder extends AbstractSorterViewHolder {
    ...
    public ColumnHeaderViewHolder(View itemView, ITableView tableView) {
        ...
        arrow_up = ContextCompat.getDrawable(itemView.getContext(), R.drawable.ic_arrow_back);
        arrow_down = ContextCompat.getDrawable(itemView.getContext(), R.drawable.ic_arrow_back_white);
